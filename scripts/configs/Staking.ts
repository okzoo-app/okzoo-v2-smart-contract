...
const config = {
    ...
    maxCap: parseUnits("100000", 0).toString(),
    minStakeAmount: parseUnits("10", 0).toString(),
    tiers: [
        {
            minStake: parseUnits("10", 0).toString(),
            maxStake: parseUnits("100", 0).toString(),
            baseAPR: parseUnits("140", 0).toString(),
        },
        {
            minStake: parseUnits("100", 0).toString(),
            maxStake: parseUnits("500", 0).toString(),
            baseAPR: parseUnits("180", 0).toString(),
        },
        {
            minStake: parseUnits("500", 0).toString(),
            maxStake: parseUnits("1000", 0).toString(),
            baseAPR: parseUnits("225", 0).toString(),
        },
        {
            minStake: parseUnits("1000", 0).toString(),
            maxStake: parseUnits("5000", 0).toString(),
            baseAPR: parseUnits("295", 0).toString(),
        },
        {
            minStake: parseUnits("5000", 0).toString(),
            maxStake: parseUnits("10000", 0).toString(),
            baseAPR: parseUnits("375", 0).toString(),
        },
        {
            minStake: parseUnits("10000", 0).toString(),
            maxStake: parseUnits("100000", 0).toString(),
