...
interface IStaking {
    ...
    function initialize(address _owner, address _stakeToken,address _rewardToken,uint256 _maxCap,uint256 _minStakeAmount, Tier[] calldata _tiers, LockPeriod[] calldata _lockPeriods) external;
